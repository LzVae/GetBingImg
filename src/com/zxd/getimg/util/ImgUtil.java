...
//			System.out.println(html);
	...
	public void saveImgOnDisk(String urlString){
		...
		try {
			...
			String diskpath = ConfigHelper.getDiskPath();
			
			String imageName;
			
			if (diskpath == null || "".equals(diskpath)) {
				
				imageName = "bingimg_"+ date_today+".jpg";
			}else {
				imageName = diskpath+"/bingimg_"+ date_today+".jpg";
			}
            ...
            System.out.println("保存成功，路径为："+ imageName);
...
//			System.out.println(simpleDateFormat.format(date));
            ...
            if (count > 0) {
                System.out.println("插入数据库成功!"+ simpleDateFormat.format(date));
            } else {
               System.out.println("插入数据库失败"+ simpleDateFormat.format(date));
            }
